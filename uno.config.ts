...
export default defineConfig({
  ...
  shortcuts: {
    'card': 'bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary-500/20',
    ...
    'btn-secondary': 'btn bg-gray-700 text-gray-100 hover:bg-gray-600',
    'container-custom': 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8',
    'section-title': 'text-2xl md:text-3xl font-bold mb-6 text-white',
